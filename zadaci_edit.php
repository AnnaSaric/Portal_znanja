...
// Izvrši upit
$rezultat = $baza->query('SELECT * FROM zadaci WHERE id_zadaci = ?', [$id]);
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 style="color: #555">Uredi zadatke</h1>
			...
			<form class="form-horizontal" action="uredi_zadatke.php" method="POST" enctype="multipart/form-data" >
			<input type="hidden" name="id" value="<?php echo $artikal['id_zadaci']; ?>">
