...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="dodaj_zadatke.php" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
                    <label for="input" class="col-sm-2 control-label" style="color: #003366">Odaberi predmet</label>
                    <div class="col-sm-10">
